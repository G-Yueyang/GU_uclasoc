...
var jack = {fname:'Gu',lname:'Yueyang',favAn:'cat'};

students.map(student => '${student.firstName}${student.favAn}')

function getNameAndFavAn(){ return students.map(student => 'The favorite Animal of ${student.firstName} is ${student.favoriteAnimal}')}

students.map(student=>'${student.firstName} ${student.favoriteAnimal}')